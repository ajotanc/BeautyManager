  ...
  <div class="products-view">
    ...
    <div class="view-header">
      ...
      <div class="header-actions">
        ...
        <Button label="Imprimir Etiquetas" icon="ri-printer-line" severity="secondary" variant="outlined" size="small"
          @click="openBatchBarcodePrint" />
    ...
    <div class="table-container glass-panel">
      <DataTable v-model:filters="filters" :value="productStore.products" paginator :rows="12"
        ...
        :global-filter-fields="['name', 'barcode']" size="small" responsive-layout="scroll"
        ...
        <!-- Código de Barras -->
        <Column field="barcode" header="Cód. Barras" sortable style="width: 110px">
          <template #body="{ data }">
        ...
        <!-- Nome do Produto -->
        <Column field="name" header="Produto" sortable style="min-width: 170px">
          <template #body="{ data }">
        ...
        <!-- Preço de Custo -->
        <Column field="cost_price" header="Custo" sortable style="width: 85px">
          <template #body="{ data }">
        ...
        <!-- Margem (%) -->
        <Column field="profit_margin" header="Margem" sortable style="width: 75px">
          <template #body="{ data }">
        ...
        <!-- Preço de Venda -->
        <Column field="selling_price" header="Preço Venda" sortable style="width: 95px">
          <template #body="{ data }">
        ...
        <!-- Estoque -->
        <Column field="stock_quantity" header="Estoque" sortable style="width: 85px">
          <template #body="{ data }">
        ...
        <!-- Validade -->
        <Column field="expiry_date" header="Validade" sortable style="width: 90px">
          <template #body="{ data }">
        ...
        <!-- Ações (Fixa à direita para nunca sumir ou exigir scroll) -->
        <Column header="Ações" frozen align-frozen="right" style="width: 135px" body-class="text-right">
          <template #body="{ data }">
...
function openBatchBarcodePrint(): void {
  selectedProduct.value = null
  showBarcodePrintDialog.value = true
}
